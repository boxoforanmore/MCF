...
tune_types[6][char_ex] = None    # The slow air provided should be added here
...
tune_types[7][char_ex] = None    # The slow air provided should be added here
...
tune_types[8][char_ex] = None    # The slow air provided should be added here


# Highland
tune_types[7][metre] = ('4/4')
tune_types[7][tempo] = ("Slow", "Not discernable")
tune_types[7][rythmic_char] = ("use of rubato")
tune_types[7][strong_beats] = None
tune_types[7][char_ex] = None    # The slow air provided should be added here
